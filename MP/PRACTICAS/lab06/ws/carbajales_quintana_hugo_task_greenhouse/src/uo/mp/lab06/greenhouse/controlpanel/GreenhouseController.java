...
import uo.mp.lab06.greenhouse.controllers.HumidityControler;
...
public class GreenhouseController {
	...
	private HumidityControler humedityController=new HumidityControler();
	
	
	/**
	 * Añade sensores de temperatura al controlador de temperatura
	 * @param sensor
	 */
    ...
    /**
     * Añade sensores de humedad al controlador de humedad
     * @param sensor
     */
	public void add(HumiditySensor sensor) {
		humedityController.add(sensor);
		scanner.add(sensor);
	}
	/**
	 * Añade puertas manejadas por el operario a el controlador de temperatura
	 * @param sensor
	 */
	...
	public void start() {
		while (true) {
			...
			display(humedityController.monitor());
