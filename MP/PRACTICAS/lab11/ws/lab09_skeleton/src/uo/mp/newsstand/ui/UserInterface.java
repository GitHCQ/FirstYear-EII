...
public class UserInterface {
	...
	private void processOption(int option) throws NewstandException, FileNotFoundException {
		switch( option ) {
			...
			case 9:orderPublicationsByName();break;
			case 10: orderOrdersByNameAndQuantity();break;
		}
	}

	private void orderOrdersByNameAndQuantity() {
		newsStand.orderPublicationsByNameAndQuantity();
	}

	private void orderPublicationsByName() {
		newsStand.orderPublicationsByName();
