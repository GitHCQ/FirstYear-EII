...
public class Game2048MoveDownTest {
	...
	public void SumOnlyFirstColumn() {
		Game2048 game = new Game2048(ForTesting.ONLYFISTCOLUMN); //{{2,0,0},{2,0,0},{0,0,0}}
		int[][] nueva = {{0, 0, 0}, {0, 0, 0}, {4, 0, 0}};
		game.moveDown();
		assertArrayEquals(nueva, game.getBoard());
	}
	@Test
	public void SumOnlySecondColumn() {
		Game2048 game = new Game2048(ForTesting.ONLYSECONDDCOLUMN); //{{0,2,0},{0,2,0},{0,0,0}}
		int[][] nueva = {{0, 0, 0}, {0, 0, 0}, {0, 4, 0}};
		game.moveDown();
		assertArrayEquals(nueva, game.getBoard());
	}
	@Test
	public void SumOnlyThirdColumn() {
		Game2048 game = new Game2048(ForTesting.ONLYTHIRDCOLUMN); //{{0,0,2},{0,0,2},{0,0,0}}
