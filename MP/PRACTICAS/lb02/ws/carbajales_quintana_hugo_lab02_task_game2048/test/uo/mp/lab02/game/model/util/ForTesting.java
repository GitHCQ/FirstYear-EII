...
public class ForTesting {
	...
	public static int[][] ONLYFISTCOLUMN = {{2,0,0},{2,0,0},{0,0,0}};
	public static int[][] ONLYSECONDDCOLUMN = {{0,2,0},{0,2,0},{0,0,0}};
	public static int[][] ONLYTHIRDCOLUMN = {{0,0,2},{0,0,2},{0,0,0}};
	
	public static int[][] ONLYFISTROW = {{2,2,0},{0,0,0},{0,0,0}};
	public static int[][] ONLYSECONDROW = {{0,0,0},{2,2,0},{0,0,0}};
	public static int[][] ONLYTHIRDROW = {{0,0,0},{0,0,0},{2,2,0}};
