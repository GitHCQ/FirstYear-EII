...
public class Game2048 {
	...
	private void rotateBoard() {
		...
		for(int i=0;i<board.length;i++) {
			for(int j=0;j<board.length;j++) {
				temp[j][board.length-1-i]=board[i][j];
			}
		}
	this.board=temp;
	}
	/**
	 * Compacta a la izquierda los números de cada fila
	 * Suma de dos en dos los números consecutivos iguales 
	 * dejando el resultado en la casilla izquierda. 
	 * Finalmente, se vuelve a compactar.
	 */
	...
	/**
	 * Compacta arriba los números de cada columna
	 * Suma de dos en dos los números consecutivos iguales 
	 * dejando el resultado en la casilla superior de la columna. 
	 * Finalmente, se vuelve a compactar.
	 */
	public void moveUp() {{
		rotateBoard();
	...
	/**
	 * Compacta abajo los números de cada columna
	 * Suma de dos en dos los números consecutivos iguales 
	 * dejando el resultado en la casilla de abajo de esa columna. 
	 * Finalmente, se vuelve a compactar.
	 */
	...
	/**
	 * Comprueba si se da la condición para terminar el juego y ganar, es decir si alguna celda contiene 
	 * un 2048 o si no se puede seguir jugando porque el tablero esta lleno.
	 * @return true si se ha terminado el juego 
	 *         o false si aun puede seguir jugando.
	 */
	public boolean isFinished() {
		for(int i=0;i<board.length;i++) {
			for(int j=0;j<board[0].length;j++) {
				if(board[i][j]==2048 || isBoardFull()) {
					return true;
				}
			}
		}
